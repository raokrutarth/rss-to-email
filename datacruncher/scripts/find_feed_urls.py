"""
https://github.com/kaflesudip/grabfeed
https://alex.miller.im/posts/python-3-feedfinder-rss-detection-from-url/
https://github.com/mediacloud/feed_seeker (working)

(this script) feedfinder: Find the Web feed for a Web page (python 2)
[works for current page only. need to traverse the nav bar as well.]
