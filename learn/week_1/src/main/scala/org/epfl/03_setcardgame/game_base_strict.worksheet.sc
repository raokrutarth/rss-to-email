...
sealed trait CardProperty

enum Shape extends CardProperty:
  case Diamond, Squiggle, Oval

enum Color extends CardProperty:
  case Red, Green, Purple

enum Shading extends CardProperty:
  case Open, Striped, Solid

enum Number extends CardProperty:
  case One, Two, Three
...
def checkProperty(
  ...
  def allSame = p1 == p2 && p2 == p3
  def allDifferent = p1 != p2 && p2 != p1 && p3 != p2
